            ...
            <CardContent>
              ...
              <div className="mt-4 text-sm text-gray-600">
                <div className="flex justify-between">
                  ...
                  <span>Goal: {startup.fundingGoal.toLocaleString()} Tokens</span>
                </div>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-gray-100">
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm text-gray-900">50 Tokens</span>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <Input
                    ...
                    onChange={(e) => setInvestmentAmount(Math.max(50, parseInt(e.target.value) || 0))}
                    min={50}
                    leftIcon={<DollarSign size={16} />}
                    helperText="Minimum investment: 50 Tokens"
                  />
